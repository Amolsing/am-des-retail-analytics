...
#import utils
# sys.path.append('E:\BW-PROJECT\am-des-retail-analytics\src\utils')
...
password = secret_data['data']['passward']
...
# Execute a query
query_result = snowflake_conn.execute_query("SELECT * from AMDB.AMSCHEMA.TRAIN_DATASET")
